...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'work-type', name: 'CompanyWorkType', component: () => import('../views/Company/WorkType.vue'), meta: { title: '任务工种' } },
      { path: 'task-schedule', name: 'CompanyTaskSchedule', component: () => import('../views/Company/TaskSchedule.vue'), meta: { title: '任务排期' } },
      { path: 'talent-pool', name: 'CompanyTalentPool', component: () => import('../views/Company/TalentPool.vue'), meta: { title: '人才库' } },
      { path: 'task-list-guide', name: 'CompanyTaskListGuide', component: () => import('../views/Company/TaskList.vue'), meta: { title: '任务列表' } },
      { path: 'task-detail/:id', name: 'CompanyTaskDetail', component: () => import('../views/Company/TaskDetail.vue'), meta: { title: '任务详情' } },
      { path: 'task-center', name: 'CompanyTaskCenter', component: () => import('../views/Company/TaskCenter.vue'), meta: { title: '任务管理' } },
      { path: 'settlement', name: 'CompanySettlement', component: () => import('../views/Company/Settlement.vue'), meta: { title: '结算记录' } },
      { path: 'attendance', name: 'CompanyAttendance', component: () => import('../views/Company/Reconciliation.vue'), meta: { title: '对账单' } },
      { path: 'account', name: 'CompanyAccount', component: () => import('../views/Company/Account.vue'), meta: { title: '账户总览' } },
      { path: 'bill-detail', name: 'CompanyBillDetail', component: () => import('../views/Company/BillDetail.vue'), meta: { title: '账单明细' } },
      { path: 'invoice-info', name: 'CompanyInvoiceInfo', component: () => import('../views/Company/Invoice.vue'), meta: { title: '开票信息' } },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'user/list', name: 'AxyUserList', component: () => import('../views/Axy/UserList.vue'), meta: { title: '人员列表' } },
      { path: 'task/list', name: 'AxyTaskList', component: () => import('../views/Axy/TaskList.vue'), meta: { title: '任务列表' } },
      { path: 'task/publish', name: 'AxyTaskPublish', component: () => import('../views/Axy/TaskPublish.vue'), meta: { title: '任务发布' } },
      { path: 'task/schedule', name: 'AxyTaskSchedule', component: () => import('../views/Axy/TaskSchedule.vue'), meta: { title: '任务排期' } },
      { path: 'attendance/check', name: 'AxyAttendanceCheck', component: () => import('../views/Axy/Attendance.vue'), meta: { title: '考勤确认' } },
      { path: 'attendance/record', name: 'AxyAttendanceRecord', component: () => import('../views/Axy/AttendanceRecord.vue'), meta: { title: '打卡记录' } },
      { path: 'attendance/stat', name: 'AxyAttendanceStat', component: () => import('../views/Axy/AttendanceStat.vue'), meta: { title: '考勤统计' } },
      { path: 'settlement/list', name: 'AxySettlementList', component: () => import('../views/Axy/Settlement.vue'), meta: { title: '结算单列表' } },
      { path: 'settlement/confirm', name: 'AxySettlementConfirm', component: () => import('../views/Axy/SalaryConfirm.vue'), meta: { title: '费用确认' } },
      { path: 'settlement/salary-rule', name: 'AxySalaryRule', component: () => import('../views/Axy/SalaryStructure.vue'), meta: { title: '费用规则' } },
      { path: 'training/course', name: 'AxyTrainingCourse', component: () => import('../views/Axy/TrainingCourse.vue'), meta: { title: '培训课程' } },
      { path: 'training/study', name: 'AxyTrainingStudy', component: () => import('../views/Axy/TrainingStudy.vue'), meta: { title: '在线学习' } },
      ...
      { path: 'insurance/apply', name: 'AxyInsuranceApply', component: () => import('../views/Axy/InsuranceApply.vue'), meta: { title: '投保申请' } },
      { path: 'contract/list', name: 'AxyContractList', component: () => import('../views/Axy/Contract.vue'), meta: { title: '合同列表' } },
      { path: 'contract/template', name: 'AxyContractTemplate', component: () => import('../views/Axy/ContractTemplate.vue'), meta: { title: '合同模板' } },
